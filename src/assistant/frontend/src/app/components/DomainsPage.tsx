...
export function DomainsPage() {
  ...
  return (
    <div className="h-full bg-white">
      <div className="h-full grid grid-cols-1 lg:grid-cols-[1fr_400px] xl:grid-cols-[1fr_450px]">
            ...
            <div className="mb-8">
              ...
              <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <TabsContent value="wellness">
                  <WellnessTab onQuickAction={handleQuickAction} />
                </TabsContent>

                <TabsContent value="productivity">
                  <ProductivityTab onQuickAction={handleQuickAction} />
                </TabsContent>

                <TabsContent value="finance">
                  <FinanceTab onQuickAction={handleQuickAction} />
                </TabsContent>

                <TabsContent value="social">
                  <SocialTab onQuickAction={handleQuickAction} />
                </TabsContent>

                <TabsContent value="goals">
                  <GoalsTab onQuickAction={handleQuickAction} />
                </TabsContent>
              </Tabs>
          </div>
        </div>
        ...
        <div className="hidden lg:block border-l border-gray-200">
          <DomainChat domain={activeTab} externalInput={chatInput} onInputUsed={() => setChatInput("")} />
        </div>
      </div>
    </div>
  );
